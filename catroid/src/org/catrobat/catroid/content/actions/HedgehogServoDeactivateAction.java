...
public class HedgehogServoDeactivateAction extends TemporalAction {

	private static final String TAG = HedgehogServoDeactivateAction.class.getSimpleName();
	...
	protected void update(float percent) {
		Log.d(TAG, "Hedgehog servo port=" + portInterpretation);
		HedgehogService.getInstance().getClient().setServo(portInterpretation, false, 0);
	}
